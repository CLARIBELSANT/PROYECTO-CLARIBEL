...
#Primero calculamos los valores de disimilitud con dist y luego usamos hclusty y especificamos el método de aglomeración que se usará (es decir, "completo", "promedio", "único", "sala.D"). Entonces podemos trazar el dendograma.
...
#hc2 <- hclust(d, method ="median" )
#hc3 <- hclust(d, method = "mean" )
