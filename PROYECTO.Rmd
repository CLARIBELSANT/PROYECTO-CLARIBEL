...
*Hacemos un gráfico de paralelas de las variables con mayor y menor correlación
```{r}
numDC<-cbind(numDC,BASE_DC$Gender)
numDC
stars(numDC[, 1:8], locations = c(0, 0), radius = FALSE,
      key.loc = c(0, 0), main = "Motor Trend Cars", lty = 2)
```

*Una manera gráfica de abordar las relaciones entre variables es utilizando una matriz de scatterplots:
```{r}
plot(numDC[,1:8], pch='*',col=c("red", "green", "blue")[unclass(numDC[,9])])
```
